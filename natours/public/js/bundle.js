...
userSettingsForm === null || userSettingsForm === void 0 ? void 0 : userSettingsForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(evnt) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          '', _readOnlyError("passwordCurrent"), _readOnlyError("password"), _readOnlyError("passwordConfirm");
        case 7:
        case "end":
          return _context.stop();
      }
