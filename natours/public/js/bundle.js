...
var displayMap = exports.displayMap = function displayMap(locations) {
  var map = new maplibregl.Map({
    container: 'map',
    // container id
    style: 'https://api.maptiler.com/maps/dataviz/style.json?key=Dts8SoqZ4IkXOU4A6RzS',
    // style URL
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://localhost:3000/api/v1/users/updateMy".concat(type === 'data' ? 'Data' : 'Password'),
            data: data
          });
        case 3:
          res = _context.sent;
...
var stripe = Stripe('pk_test_51QiUVwG6CWicCQF08iucxBnVBhO3r6GTDOy4QXzAPJsgGNZ79Dk4lNppZMp6haLkZBJolTHqm0eKw6O2VHdJM1sq00jPOWaX42');
...
var userSettingsForm = document.querySelector('.form-user-password');
...
loginForm === null || loginForm === void 0 || loginForm.addEventListener('submit', function (evnt) {
  evnt.preventDefault();
  // Values
...
logoutBtn === null || logoutBtn === void 0 || logoutBtn.addEventListener('click', _logout.logout);
userDataForm === null || userDataForm === void 0 || userDataForm.addEventListener('submit', function (evnt) {
  evnt.preventDefault();
...
userSettingsForm === null || userSettingsForm === void 0 || userSettingsForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(evnt) {
...
bookBtn === null || bookBtn === void 0 ? void 0 : bookBtn.addEventListener('click', function (evnt) {
  evnt.target.textContent = 'Processing...';
  var tourId = evnt.target.dataset.tourId;
